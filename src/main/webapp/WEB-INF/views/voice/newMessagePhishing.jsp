    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            function addMessagesSequentially(messages, type, delay, callback) {
                ...
                addMessage(messages[0], type, function () {
                    setTimeout(function () {
            ...
            function addMessage(content, type, callback) {
                ...
                if (isSpeakingEnabled) {
                    speakText(content, type === 'received' ? 'mijin' : 'jinho', callback); // 범죄자와 사용자의 목소리 설정
                } else if (callback) {
                    callback();
                }
            }
            ...
            function updateChat(choice) {
                ...
                addMessage(choice, 'sent', function () {
                    switch (choice) {
                        ...
                        case '어떻게 도와줘?':
                            addMessagesSequentially([
                                '중고거래로 휴대폰을 사려고 하는데 이체가 안돼서 아빠가 먼저 돈 좀 보내줄 수 있어?',
