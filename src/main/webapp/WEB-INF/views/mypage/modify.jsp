						...
						<br/><br/>
							...
							<div class="form-group">
								<label for="name">이름</label> <input class="form-control"
									type="text" id="name" name="name" required="" value= "${userInfo.name}" readonly>
							</div>
							<div class="form-group">
								<label for="name">아이디</label> <input class="form-control"
									type="id" id="id" name="id" required="" value= "${userInfo.user_id}" readonly>
							</div>
							<div class="form-group">
								<label for="name">Email</label> <input class="form-control"
									type="email" id="email" name="email" required="" value= "${userInfo.email}">
							</div>
							<%-- <div class="form-group">
