            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="promo-wrap">
                        <h1 class="promo-title">KB큽스쿨 <span>로그인</span></h1>
            ...
            <div class="row">
                <div class="col-lg-7 mx-auto">
                    <div class="login-wrap bg-light">
                        <h2 class="fw-normal mb-5 h6"> KB큽스쿨<span
                                class="fw-bold tex-primary d-block display-5 ">로그인</span></h2>
                        ...
                        <form action="#">
                            ...
                            <label class="remember" for="remember">
                                <input type="checkbox" id="remember" value="Remember"> 자동 로그인
                            </label>
