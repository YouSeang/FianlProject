...
<body>
    ...
    <header class="hearer header-2">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container px-lg-0">
                <a class="navbar-brand" href="./index.html"><img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/components/logo.png" alt="Logo"></a>
                <button class="navbar-toggler offcanvas-nav-btn" type="button">
                    <i class="fa fa-bars"></i>
                </button>
                <div class="offcanvas offcanvas-start offcanvas-nav">
                    <div class="offcanvas-header">
                        <a href="./index.html" class="text-inverse"><img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/components/logo.png"
                                alt="Logo"></a>
                        ...
                        <ul class="navbar-nav mx-auto align-items-lg-center">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">사고예방</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="./about.html">금융사고 현황</a></li>
                                     <li><a class="dropdown-item" href="./about.html">신종기법 및 사례</a></li>
                                    <li class="dropdown-submenu dropend">
                                        <a class="dropdown-item dropdown-toggle" href="./volunteer.html">금융사고예방 시뮬레이션</a>
                                        <ul class="dropdown-menu">
                                            <li class="dropdown-header">금융사고예방 시뮬레이션</li>
                                            <li><a class="dropdown-item" href="./volunteer.html">메신저피싱</a></li>
                                            <li><a class="dropdown-item" href="./volunteer-single.html">보이스피싱</a></li>
                                        </ul>
                                    </li>
                        </ul></li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                <li class="dropdown-header">금융사고예방 시뮬레이션</li>
                                    <li><a class="dropdown-item" href="./causes.html">KB스타뱅킹 체험</a></li>
    ...
    <section class="banner-area">
        <div class="banner-2 owl-carousel">
            <div class="single-banner" style="background-image: url('${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/banner/cta-bg.jpg')">
                <div class="container">
            ...
            <!-- Single Banner End -->
            <div class="single-banner" style="background-image: url('${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/banner/banner5.jpg')">
                <div class="container">
                    <div class="banner-info">
            ...
            <!-- Single Banner End -->
            <div class="single-banner" style="background-image: url('${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/banner/banner4.jpg')">
                <div class="container">
                    <div class="banner-info">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-4">
                    <div class="single-inspiration">
                        <span><img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/components/mis1.png" alt=""></span>
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="single-inspiration">
                        <span><img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/components/mis2.png" alt=""></span>
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="single-inspiration">
                        <span><img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/components/mis3.png" alt=""></span>
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="f-cause-wrap owl-carousel">
                        <div class="f-cause-img">
                            <a href="#"><img class="img-rounded" src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/causes/cs4.jpg" alt=""></a>
                        </div>
                        <div class="f-cause-img">
                            <a href="#"><img class="img-rounded" src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/causes/cs5.jpg" alt=""></a>
                        </div>
                        <div class="f-cause-img">
                            <a href="#"><img class="img-rounded" src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/causes/cs6.jpg" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-4">
                    <div class="single-project rounded-2 shadow">
                        <figure class="project-thumb">
                            <img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/causes/cause1.jpg" alt="">
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="single-project rounded-2 shadow">
                        <figure class="project-thumb">
                            <img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/causes/cs3.jpg" alt="">
                        </figure>
                        <div class="project-info p-lg-4 p-3">
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="single-project rounded-2 shadow">
                        <figure class="project-thumb">
                            <img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/project/pr1.jpg" alt="">
                        </figure>
                        <div class="project-info p-lg-4 p-3">
    ...
    <section class="donation-area section-padding" style="background-image: url('${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/banner/donation.jpg');"
                    ...
                    <div class="team-wrap owl-carousel">
                        <div class="team-member">
                            <figure class="team-thumb">
                                <img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/team/tm3.jpg" alt="">
                        ...
                        <div class="team-member">
                            <figure class="team-thumb">
                                <img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/team/tm4.jpg" alt="">
                                <div class="member-social">
                                    <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="#"><i class="fa-brands fa-twitter"></i></a>
                                    <a href="#"><i class="fa-brands fa-linkedin-in"></i></a>
                        ...
                        <div class="team-member">
                            <figure class="team-thumb">
                                <img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/team/tm1.jpg" alt="">
                                <div class="member-social">
                                    <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="#"><i class="fa-brands fa-twitter"></i></a>
                                    <a href="#"><i class="fa-brands fa-linkedin-in"></i></a>
                        ...
                        <div class="team-member">
                            <figure class="team-thumb">
                                <img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/team/tm2.jpg" alt="">
                                <div class="member-social">
                                    <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                                    <a href="#"><i class="fa-brands fa-twitter"></i></a>
                                    <a href="#"><i class="fa-brands fa-linkedin-in"></i></a>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="footer-widget footer-about">
                        <div class="f-logo"><a href="#">
                                <img src="${pageContext.request.contextPath}/resources/${pageContext.request.contextPath}/resources/images/components/f-logo.png" alt="Logo">
                            </a></div>
