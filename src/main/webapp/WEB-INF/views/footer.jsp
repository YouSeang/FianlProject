    ...
    <footer id="footer" class="footer">
        <div class="footerWrap" id="footerWrap">
            <div class="footer_top">
                <div class="ft_inner">
                    <ul class="data-gather">
                        ...
                        <li><a href="/cms/content/view/548" title="이메일무단수집거부 이동">이메일무단수집거부</a></li>
                        <li><a href="https://www.kofac.re.kr/cms/content/view/491" target="_blank" title="클릭하시면 새 창으로 열립니다.">저작권정책</a></li>
                    </ul>
                    <div class="familyWrap">
                        ...
                        <li>
                            ...
                            <li><a href="https://smart.kofac.re.kr/home/kor/main.do" target="_blank" title="새 창으로 열립니다">스마트 수·과학실</a></li>
            ...
            <div class="footer_btm">
                ...
                <div class="address">
                    <ul>
                        <li><p><i class="fas fa-map-marker-alt"></i>(06621) 서울시 서초구 서초대로74길 33 DIGICAMPUS 3기</p></li>
                        <li><p><i class="fas fa-phone-alt"></i>02-123-4567</p><p><i class="far fa-envelope"></i>ringdingding@dicam.kb</p></li>
                    </ul>
                    <p>Copyright © RINGDINGDING. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
