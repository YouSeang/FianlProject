			...
			<div class="row">
				<div class="col-lg-12">
					<div class="promo-wrap">
						<h1 class="promo-title">Testimonials</h1>
			...
			<div class="row">
				<div class="col-lg-6 col-sm-12">
					<div class="single-testimonial">
						...
						<div class="s-details">
							<h3>
								Richar Hally<span class="status">CEO, Help</span>
							</h3>
							<p>Help fugit molestias quas enim dignissimos ad cupiditate
								sapiente facere praesentium.fugit molestias quas enim
								dignissimos</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 col-sm-12">
					<div class="single-testimonial">
						...
						<div class="s-details">
							<h3>
								Falcon Waller<span class="status">CEO, Xy-company</span>
							</h3>
							<p>Help fugit molestias quas enim dignissimos ad cupiditate
								sapiente facere praesentium.fugit molestias quas enim
								dignissimos</p>
				...
				<div class="col-lg-6 col-sm-12">
					<div class="single-testimonial">
						...
						<div class="s-details">
							<h3>
								Selara Gase<span class="status">CEO, Help</span>
							</h3>
							<p>Help fugit molestias quas enim dignissimos ad cupiditate
								sapiente facere praesentium.fugit molestias quas enim
								dignissimos</p>
				...
				<div class="col-lg-6 col-sm-12">
					<div class="single-testimonial">
						...
						<div class="s-details">
							<h3>
								Josefa Rosa<span class="status">CEO, Help</span>
							</h3>
							<p>Help fugit molestias quas enim dignissimos ad cupiditate
								sapiente facere praesentium.fugit molestias quas enim
								dignissimos</p>
				...
				<div class="col-lg-6 col-sm-12">
					<div class="single-testimonial">
						<div class="s-thumb">
							<img src="${pageContext.request.contextPath}/resources/images/team/tm5.jpg" alt="">
						</div>
						<div class="s-details">
							<h3>
								Andrew carlos<span class="status">CEO, Help</span>
							</h3>
							<p>Help fugit molestias quas enim dignissimos ad cupiditate
								sapiente facere praesentium.fugit molestias quas enim
								dignissimos</p>
				...
				<div class="col-lg-6 col-sm-12">
					<div class="single-testimonial">
						<div class="s-thumb">
							<img src="${pageContext.request.contextPath}/resources/images/team/tm7.jpg" alt="">
						</div>
						<div class="s-details">
							<h3>
								Isabela Gomez<span class="status">CEO, Help</span>
							</h3>
							<p>Help fugit molestias quas enim dignissimos ad cupiditate
								sapiente facere praesentium.fugit molestias quas enim
								dignissimos</p>
				...
				<div class="col-lg-6 col-sm-12">
					<div class="single-testimonial">
						<div class="s-thumb">
							<img src="${pageContext.request.contextPath}/resources/images/team/tm6.jpg" alt="">
						</div>
						<div class="s-details">
							<h3>
								Allen border<span class="status">CEO, Help</span>
							</h3>
							<p>Lorem ipsum dolor sit amet.Help fugit molestias quas enim
								dignissimos ad cupiditate sapiente facere praesentium.fugit
								molestias quas enim dignissimos</p>
						</div>
					</div>
				</div>
				<!-- Single Testimonial End -->
				<div class="col-lg-6 col-sm-12">
					<div class="single-testimonial">
						<div class="s-thumb">
							<img src="${pageContext.request.contextPath}/resources/images/team/tm8.jpg" alt="">
						</div>
						<div class="s-details">
							<h3>
								Sofia Rame<span class="status">CEO, Help</span>
							</h3>
							<p>Help fugit molestias quas enim dignissimos ad cupiditate
								sapiente facere praesentium.fugit molestias quas enim
								dignissimos</p>
