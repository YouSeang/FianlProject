...
<body>
	...
	<!-- Main Area Start -->
	<h1>스미싱 케이스 관리</h1>
	<form action="${pageContext.request.contextPath}/admin/addSmishingCase"
		method="post">
		<label for="type">케이스 유형:</label> <input type="text" id="type"
			name="type" required><br> <label for="description">설명:</label>
		<textarea id="description" name="description" required></textarea>
		<br> <label for="imageUrl">이미지 URL:</label> <input type="text"
			id="imageUrl" name="imageUrl" required><br>
