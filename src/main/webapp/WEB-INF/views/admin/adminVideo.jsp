	...
	<main class="main-content">
		<div class="container mt-5">
			...
			<div class="text-end mb-3">
				<a href="${pageContext.request.contextPath}/admin/videoAdd"
					class="btn btn-primary">새 비디오 추가</a>
			</div>
								...
								<div class="single-article shadow bg-white">
									...
									<div class="article-details">
										<h3 class="article-heading">
											<a href="${video.link}" target="_blank"> <c:out
										...
										<a
											href="${pageContext.request.contextPath}/admin/videoEdit?id=${video.id}"
											class="btn btn-warning btn-sm">Edit</a>
										<form
											action="${pageContext.request.contextPath}/admin/videoDelete"
