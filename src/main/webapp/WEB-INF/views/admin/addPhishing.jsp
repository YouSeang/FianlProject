                ...
                <c:if test="${not empty scenarios}">
                    <c:forEach var="scenario" items="${scenarios}">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link ${scenario == scenarios[0] ? 'active' : ''}" id="scenario${scenario.id}-tab" data-toggle="tab" href="#scenario${scenario.id}" role="tab" aria-controls="scenario${scenario.id}" aria-selected="${scenario == scenarios[0] ? 'true' : 'false'}">${scenario.scenarioName}</a>
                        </li>
                    </c:forEach>
                </c:if>
                <c:if test="${empty scenarios}">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="newScenarioForm-tab" data-toggle="tab" href="#newScenarioForm" role="tab" aria-controls="newScenarioForm" aria-selected="true">New Scenario</a>
                    </li>
                </c:if>
            </ul>
