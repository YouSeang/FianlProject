...
<meta name="description"
	content="Password reset form for KB Kips School">
<meta name="author" content="Your Name">

<!-- Template Title -->
<title>비밀번호 재설정 - KB Kips School</title>
				...
				<div class="col-lg-7 mx-auto">
					<div class="login-wrap bg-light">
						<h2 class="h6 fw-normal mb-5">
							<span class="fw-bold tex-primary d-block display-5">새 비밀번호
								설정</span>
						</h2>
						<form role="form"
							...
							<div class="form-group">
								<label for="password">새 비밀번호:</label> <input
							...
							<button class="custom-btn mt-3" type="submit">비밀번호 재설정</button>
						</form>
					</div>
				</div>
			</div>
